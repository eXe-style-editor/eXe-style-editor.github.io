# Estadisticas IONOS para `editor-estilos`
...
```text
/homepages/43/d785639964/htdocs/app/estadistica/editor-estilos/
```

URL publicas previstas:

- `https://bilateria.org/app/estadistica/editor-estilos/track.php`
- `https://bilateria.org/app/estadistica/editor-estilos/admin-stats.php`
